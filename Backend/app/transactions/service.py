...
async def sync_transactions(
    ...
    # Re-detect recurring charges on every sync, even when no new transactions
    # arrived — existing data may not have been processed yet, and confirmed /
    # dismissed state could have changed since last detection.
